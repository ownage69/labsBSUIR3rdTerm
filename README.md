...
| 6 | [Лабораторная работа №6: Генерация и обработка исключительных ситуаций](./6lab) | ✅ |
| 7 | [Лабораторная работа №7: Потоки ввода/вывода. Работа с файлами](./7lab) | ✅ |
| 8 | [Лабораторная работа №5: Классы контейнеры-итераторы. STL-контейнеры](./8lab) | ✅ |
